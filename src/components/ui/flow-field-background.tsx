...
interface NeuralBackgroundProps {
   ...
   * Defaults to website's primary green.
   */
  color?: string;
  /**
...
export default function NeuralBackground({
  className,
  color = "#22c55e", // Primary green matching website theme
  trailOpacity = 0.12,
  particleCount = 600,
  speed = 0.8,
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Using the website's dark teal background color
      ctx.fillStyle = `rgba(13, 26, 20, ${trailOpacity})`;
